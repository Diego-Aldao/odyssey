            ...
            <>
              ...
              >
                <div className="gap-1 flex flex-col items-start xs:flex-row-reverse xs:justify-end xs:gap-2">
                  <p className="line-clamp-1 text-xs xs:text-sm md:text-xs lg:text-base font-medium">
                    {rol.anime.title}
                  </p>
              ...
              >
                <div className="gap-1 flex flex-col items-end xs:flex-row xs:items-start xs:justify-end xs:gap-2">
                  <p className="line-clamp-1 text-xs text-end xs:text-sm md:text-xs lg:text-base font-medium lg:flex lg:flex-col lg:gap-2">
                    {rol.character.name}
