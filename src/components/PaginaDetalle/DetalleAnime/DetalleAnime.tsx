  ...
  const dataTags: InfoTags[] = [
    {
      id: 1,
      nombre: "score",
      data: String(respuestaApi?.data.score),
    ...
    },
    {
      id: 2,
      nombre: "estudios",
      data: String(respuestaApi?.data.studios[0].name),
    },
    {
      id: 3,
      nombre: "rank",
      data: String(respuestaApi?.data.rank),
      esRankeable: true,
    },
    {
      id: 4,
      nombre: "popularidad",
      data: String(respuestaApi?.data.popularity),
      ocultoMovile: true,
      esRankeable: true,
    },
    {
