  ...
  return (
    ...
    >
      <header className="mb-10 md:mb-0 relative md:min-h-[280px] lg:min-h-[400px]">
        <h2 className="max-w-[400px] mx-auto md:mx-0 uppercase font-chivo text-4xl sm:text-5xl  md:text-7xl  lg:text-[115px] text-center md:text-left  font-bold md:-tracking-[5px] md:max-w-[62%] lg:max-w-[700px] lg lg:-tracking-[10px] relative z-[2] md:text-main-color-background-static md:drop-shadow-[0px_0px_8px_#000000] md:[text-shadow:_5px_5px_#23210f]">
          {titulo}
        </h2>
        {imagenHeader}
      </header>
      ...
      <button
        ...
        } item-skew-x after:rounded-b-none after:rounded-t-[5px] after:skew-x-[-331deg] before:rounded-b-none before:rounded-t-[5px] before:skew-x-[331deg] z-[1] relative mt-10 mx-auto px-2 py-2 bg-main-black text-main-color-background capitalize text-xs md:text-base md:px-5 font-medium`}
      >
        ver mas
      </button>
    </motion.section>
