...
const Footer: React.FC<Props> = ({ score, miembros }) => {
  return (
    ...
    md:justify-evenly md:text-xs bg-main-black item-skew-x z-[1] relative after:-right-[10px] after:w-[50px] after:skew-x-[-331deg] after:rounded-b-none after:rounded-t-[5px] before:rounded-t-[5px] before:-left-[10px] before:w-[50px] before:skew-x-[331deg] before:rounded-b-none  xs:py-1"
      >
