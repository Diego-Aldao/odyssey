...
const MainCardAnime: React.FC<Props> = ({ animeWallpaper }) => {
  return (
    <div className="main_card_anime custom-border">
      <button className="absolute hidden xs:flex flex-col items-center justify-center -right-8 top-[40%] bg-main-color border-[1.5px] border-main-black rounded-full p-2 py-4">
        <Icon
          icon="fa6-solid:dice"
          rotate={3}
          hFlip={true}
